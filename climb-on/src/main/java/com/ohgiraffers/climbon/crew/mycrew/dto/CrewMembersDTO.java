...
public class CrewMembersDTO {
    ...
    public CrewMembersDTO() {
    }

    public CrewMembersDTO(Integer crewCode, CrewRole role, Integer id, String nickname, String userId, String password, UserRole userRole, String profilePic, String oneLiner, int facilityCode, int status, Boolean isBusiness, LocalDateTime createdAt, LocalDateTime inactiveAt) {
